...
for a in range(8):
    ...
    ResultData[0,a] = Sizing_instance.WT()
    ResultData[1,a] = Sizing_instance.BESS()
    ResultData[2,a] = Sizing_instance.El()
    ResultData[3,a] = Sizing_instance.FC()
    ResultData[4,a] = Sizing_instance.Cavern()/Sizing_instance.H2_kwh()
    ResultData[5,a] = (Sizing_instance.Cost()-Sizing_instance.Operation())/1000000
    ResultData[6,a] = Sizing_instance.Operation()/1000000
    ResultData[7,a] = Sizing_instance.Cost()/1000000
